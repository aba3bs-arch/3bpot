...
if (!isServerless) {
    const staticDirs = ['shared', 'admin', 'agente', 'cajero', 'portal', 'inicio', 'spin-game', 'comic-slot', 'crystal-wins', 'rancho-lazo', 'laguna-anzuelo', 'rascadito', 'desenreda-cable', 'loteria', 'rompecabezas', 'calle-pelea'];
